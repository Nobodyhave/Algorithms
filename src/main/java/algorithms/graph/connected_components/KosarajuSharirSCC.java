...
package algorithms.graph.connected_components;
...
public class KosarajuSharirSCC {
    ...
    public KosarajuSharirSCC(Digraph G) {
        ...
        algorithms.graph.topological.DepthFirstOrder dfs = new algorithms.graph.topological.DepthFirstOrder(G.reverse());
