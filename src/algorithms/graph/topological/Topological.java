...
public class Topological {
    ...
    public Topological(Digraph G) {
        algorithms.graph.topological.DirectedCycle finder = new algorithms.graph.topological.DirectedCycle(G);
        if (!finder.hasCycle()) {
            algorithms.graph.topological.DepthFirstOrder dfs = new algorithms.graph.topological.DepthFirstOrder(G);
